 ...
 * </ul>
 * 
 * All relevant parameters such as the temporal and spatial resolution are specified in {@link ch.matsim.eth.noise_costs.NoiseConfigGroup}.
 * <p>
 * 
 * There are two possible use cases:
 * <ul>
 * <li> Run an offline noise computation for analysis purposes, see {@link ch.matsim.eth.noise_costs.examples.NoiseOfflineCalculationExample}.
 * <li> Run an online noise computation, see {@link ch.matsim.eth.noise_costs.examples.NoiseOnlineControlerExample}. Noise damages may be internalized applying different allocation approaches, see {@link ch.matsim.eth.noise_costs.data.NoiseAllocationApproach}.
 * </ul>
 * 
